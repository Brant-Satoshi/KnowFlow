...
const olympusZh: EvalCase[] = [
  {
    ...
    expectedKeywords: ['科瓦奇', '埃琳娜'],
    targetFileNames: ['sample-zh.txt'],
  ...
  },
  {
    ...
    category: 'list_extraction',
    difficulty: 'medium',
    question: '该项目运营哪些轨道气象站？',
    expectedAnswer: '三座气象站：赫利俄斯、维斯塔和代达罗斯。',
    expectedKeywords: ['赫利俄斯', '维斯塔', '代达罗斯'],
    targetFileNames: ['sample-zh.txt'],
  ...
  },
  {
    ...
    expectedKeywords: ['4.2 亿', '信用点', '火星联合体'],
    targetFileNames: ['sample-zh.txt'],
  ...
  },
  {
    ...
    category: 'synthesis',
    difficulty: 'hard',
    question: '第二阶段的时间表和重点是什么？',
    expectedAnswer: '第二阶段从 2027 年到 2030 年，将把覆盖范围扩展到南极地区。',
    expectedKeywords: ['第二阶段', '2027', '2030', '南极'],
    targetFileNames: ['sample-zh.txt'],
  ...
  },
  {
    ...
    expectedKeywords: ['代达罗斯', '压力波', '41 小时'],
    targetFileNames: ['sample-zh.txt'],
  ...
  },
  {
    ...
    expectedKeywords: ['塔尔西斯', '沙尘暴', '18%', '近日点'],
    targetFileNames: ['sample-zh.txt'],
